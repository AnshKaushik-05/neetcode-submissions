...
public:
    ...
    void islandsAndTreasure(vector<vector<int>>& grid) {
        ...
        //vector<vector<bool>>vis(m,vector<bool>(n,false)); // no need to maintain vis as grid itself acts like a visited array
        //if we update distance of a node only if grid[x][y]==2147483647 , once it has been updated to we don't enter the if-block
        //and hence we don't change the dst of that node 
